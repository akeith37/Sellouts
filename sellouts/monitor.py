...
async def check_tickets_loop(page, shutdown_event):
    ...
    while not shutdown_event.is_set():
        try:
            ...
            await asyncio.wait_for(page.reload({'waitUntil': 'networkidle2'}), timeout=20)
            await asyncio.wait_for(page.waitForSelector("script[type='application/ld+json']"), timeout=20)
